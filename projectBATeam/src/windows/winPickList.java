...
public final class winPickList extends JDialog {

	private static final long serialVersionUID = 1L;
    private static JTable DgTable;
	private static Integer NoLigneSel = 0;
	
	private winPickList(AbstractTableModel model,String Title) {
